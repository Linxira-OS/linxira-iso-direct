...
./build-direct-iso.sh \
  ...
  --components-package /path/to/linxira-components-0.6.0-1-any.pkg.tar.zst \
  ...
  --hardware-driver-manager-package /path/to/linxira-hardware-driver-manager-0.3.0-1-any.pkg.tar.zst \
